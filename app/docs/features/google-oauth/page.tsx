...
const page = () => {
    ...
    useEffect(() => {
        let result;
        const getData = async () => {
            result = await fetchData('../../../../data/google-oauth.json');
            if (activeContent == "1") {
    ...
    return (
        <div className='p-8 md:p-12 '>
            ...
            <div className="py-10 flex flex-col text-base-content/80 max-w-xl">
                ...
                {/* next-auth */}
                <div className="py-2">
                    {pageContent.next_complexText_1 && (<ComplexText content={pageContent.next_complexText_1} className='py-8 text-gray-300 text-sm' />)}
                    {pageContent.next_google_subTitle && (
                        <div className="py-2">
                            <SubTitle text={pageContent.next_google_subTitle} />
                        </div>
                    )}
                    ...
                    {pageContent.next_plainText_1 && (<PlainText content={pageContent.next_plainText_1} className='py-4 text-gray-400' />)}
                    {pageContent.next_plainText_2 && (<PlainText content={pageContent.next_plainText_2} className='py-4 text-gray-400' />)}
                    {pageContent.next_plainText_3 && (<PlainText content={pageContent.next_plainText_3} className='py-4 text-gray-400' />)}
                    {pageContent.next_plainText_4 && (<PlainText content={pageContent.next_plainText_4} className='py-4 text-gray-400' />)}
                    ...
                    {pageContent.next_highlightedNote_2 && (
                        <HighLightedNote content={pageContent.next_highlightedNote_2} className='py-2' />
                    )}
                </div>
                ...
                <div className="py-2">
                    {pageContent.google_subTitle && (
                        <div className="py-2">
                            <SubTitle text={pageContent.google_subTitle} />
                        </div>
                    )}
                    ...
                    {pageContent.supabase_plainText_3 && (<PlainText content={pageContent.supabase_plainText_3} className='py-4 text-gray-400' />)}
                    {pageContent.supabase_plainText_4 && (<PlainText content={pageContent.supabase_plainText_4} className='py-4 text-gray-400' />)}
                    ...
                    {pageContent.supabase_highlightedNote_2 && (
                        <HighLightedNote content={pageContent.supabase_highlightedNote_2} className='py-2' />
                    )}
                </div>
